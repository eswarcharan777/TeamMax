...
const styles = {
  ...
  reportHeader: {
    background: "linear-gradient(135deg, #f9731622, #ef444411)",
    borderBottom: "1px solid #21262d",
    padding: "16px 24px",
    display: "flex",
    alignItems: "center",
        ...
        <main style={styles.main}>
          ...
          <div style={styles.agentRow}>
            {AGENTS.map((a, i) => (
              <div key={a} style={{
                ...styles.agentBadge,
                ...(activeAgent >= i ? { borderColor: "#f97316", color: "#f97316", background: "#f9731611" } : {})
              }}>
            ...
            <div style={{ ...styles.uploadArea, ...(image ? styles.uploadAreaActive : {}) }}>
              ...
              {!image ? (
                ...
                <div style={styles.uploadSelected}>
                  ...
                  <span style={{ marginLeft: "auto", color: "#7d8590", fontSize: 12 }}>
          ...
          <div style={styles.card}>
            ...
            <textarea
              ...
              placeholder="e.g. Bearing making unusual grinding noise, possible overheating since last shift..."
              value={input}
